...
subtitle: "Quantum Bayesian Inference: Experimental Validation and Extensions · NCHU Department of Applied Mathematics"
format:
  html:
    theme: cosmo
    toc: true
...
Project No. 112-2813-C-005-038-E · Advisor: Prof. Yu-Tsung Tai · Period: 2023/07 -- 2024/02
:::
...
![Simulator: Cumulative P(0) over 20,000 measurements --- converges to 0.5](am_qc_20k.png){width=85%}
...
![IBM Osaka: Cumulative P(0) over 20,000 measurements --- drifts below 0.5](am_sim_20k.png){width=85%}
